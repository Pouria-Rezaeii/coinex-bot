...
export const trader_60 = (rq: number, results: any[]) => {
  ...
  if (bchToAdaDiff <= -0.6 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToVetDiff <= -0.6 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToBnbDiff <= -0.6 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToSolDiff <= -0.6 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToDotDiff <= -0.6 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEosDiff <= -0.6 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToLtcDiff <= -0.6 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEtcDiff <= -0.6 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToTrxDiff <= -0.6 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
