...
export const trader_50 = (rq: number, results: any[]) => {
  ...
  if (adaToBchDiff > 0.5 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  if (vetToBchDiff > 0.5 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  if (bnbToBchDiff > 0.5 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  if (solToBchDiff > 0.5 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  if (dotToBchDiff > 0.5 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  if (eosToBchDiff > 0.5 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  if (ltcToBchDiff > 0.5 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  if (etcToBchDiff > 0.5 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  if (trxToBchDiff > 0.5 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
  ...
  // xrp - - - - - - - - - - - - - - - - - - - - -
  if (bchToXrpDiff > 0.5 && wallet.XRP === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (xrpToBchDiff > 0.5 && wallet.XRP > 0) {
    wallet = {
      ...wallet,
  ...
  // doge - - - - - - - - - - - - - - - - - - - - -
  if (bchToDogeDiff > 0.5 && wallet.DOGE === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (dogeToBchDiff > 0.5 && wallet.DOGE > 0) {
    wallet = {
      ...wallet,
