...
export const trader_35 = (rq: number, results: any[]) => {
  ...
  if (bchToAdaDiff <= -0.35 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToVetDiff <= -0.35 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToBnbDiff <= -0.35 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToSolDiff <= -0.35 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToDotDiff <= -0.35 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEosDiff <= -0.35 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToLtcDiff <= -0.35 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEtcDiff <= -0.35 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToTrxDiff <= -0.35 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
