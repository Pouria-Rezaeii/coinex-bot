...
export const trader_45 = (rq: number, results: any[]) => {
  ...
  if (bchToAdaDiff <= -0.45 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToVetDiff <= -0.45 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToBnbDiff <= -0.45 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToSolDiff <= -0.45 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToDotDiff <= -0.45 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEosDiff <= -0.45 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToLtcDiff <= -0.45 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEtcDiff <= -0.45 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToTrxDiff <= -0.45 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
