...
export const trader_45 = (rq: number, results: any[]) => {
  ...
  // ada - - - - - - - - - - - - - - - - - - - - -
  if (bchToAdaDiff > 0.45 && wallet.ADA === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
  ...
  if (adaToBchDiff > 0.45 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  // vet - - - - - - - - - - - - - - - - - - - - -
  if (bchToVetDiff > 0.45 && wallet.VET === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (vetToBchDiff > 0.45 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  // bnb - - - - - - - - - - - - - - - - - - - - -
  if (bchToBnbDiff > 0.45 && wallet.BNB === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bnbToBchDiff > 0.45 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  // sol - - - - - - - - - - - - - - - - - - - - -
  if (bchToSolDiff > 0.45 && wallet.SOL === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (solToBchDiff > 0.45 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  // dot - - - - - - - - - - - - - - - - - - - - -
  if (bchToDotDiff > 0.45 && wallet.DOT === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (dotToBchDiff > 0.45 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  // eos - - - - - - - - - - - - - - - - - - - - -
  if (bchToEosDiff > 0.45 && wallet.EOS === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (eosToBchDiff > 0.45 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  // ltc - - - - - - - - - - - - - - - - - - - - -
  if (bchToLtcDiff > 0.45 && wallet.LTC === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (ltcToBchDiff > 0.45 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  // etc - - - - - - - - - - - - - - - - - - - - -
  if (bchToEtcDiff > 0.45 && wallet.ETC === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (etcToBchDiff > 0.45 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  // trx - - - - - - - - - - - - - - - - - - - - -
  if (bchToTrxDiff > 0.45 && wallet.TRX === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (trxToBchDiff > 0.45 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
  ...
  // xrp - - - - - - - - - - - - - - - - - - - - -
  if (bchToXrpDiff > 0.45 && wallet.XRP === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (xrpToBchDiff > 0.45 && wallet.XRP > 0) {
    wallet = {
      ...wallet,
  ...
  // doge - - - - - - - - - - - - - - - - - - - - -
  if (bchToDogeDiff > 0.45 && wallet.DOGE === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (dogeToBchDiff > 0.45 && wallet.DOGE > 0) {
    wallet = {
      ...wallet,
