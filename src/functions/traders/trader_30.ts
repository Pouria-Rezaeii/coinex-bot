...
export const trader_30 = (rq: number, results: any[]) => {
  ...
  // ada - - - - - - - - - - - - - - - - - - - - -
  if (bchToAdaDiff > 0.3 && wallet.ADA === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToAdaDiff < -0.3 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  // vet - - - - - - - - - - - - - - - - - - - - -
  if (bchToVetDiff > 0.3 && wallet.VET === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToVetDiff < -0.3 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  // bnb - - - - - - - - - - - - - - - - - - - - -
  if (bchToBnbDiff > 0.3 && wallet.BNB === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToBnbDiff < -0.3 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  // sol - - - - - - - - - - - - - - - - - - - - -
  if (bchToSolDiff > 0.3 && wallet.SOL === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToSolDiff < -0.3 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  // dot - - - - - - - - - - - - - - - - - - - - -
  if (bchToDotDiff > 0.3 && wallet.DOT === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToDotDiff < -0.3 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  // eos - - - - - - - - - - - - - - - - - - - - -
  if (bchToEosDiff > 0.3 && wallet.EOS === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToEosDiff < -0.3 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  // ltc - - - - - - - - - - - - - - - - - - - - -
  if (bchToLtcDiff > 0.3 && wallet.LTC === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToLtcDiff < -0.3 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  // etc - - - - - - - - - - - - - - - - - - - - -
  if (bchToEtcDiff > 0.3 && wallet.ETC === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToEtcDiff < -0.3 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  // trx - - - - - - - - - - - - - - - - - - - - -
  if (bchToTrxDiff > 0.3 && wallet.TRX === 0 && avPortion > 0) {
    wallet = {
      ...wallet,
      BCH: wallet.BCH - bchEachP,
  ...
  if (bchToTrxDiff < -0.3 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
