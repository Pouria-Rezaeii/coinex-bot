...
export const trader_55 = (rq: number, results: any[]) => {
  ...
  if (bchToAdaDiff <= -0.55 && wallet.ADA > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToVetDiff <= -0.55 && wallet.VET > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToBnbDiff <= -0.55 && wallet.BNB > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToSolDiff <= -0.55 && wallet.SOL > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToDotDiff <= -0.55 && wallet.DOT > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEosDiff <= -0.55 && wallet.EOS > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToLtcDiff <= -0.55 && wallet.LTC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToEtcDiff <= -0.55 && wallet.ETC > 0) {
    wallet = {
      ...wallet,
  ...
  if (bchToTrxDiff <= -0.55 && wallet.TRX > 0) {
    wallet = {
      ...wallet,
